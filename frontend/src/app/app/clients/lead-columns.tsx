...
function LeadActionsCell({ lead, onConvert }: { lead: LeadRead; onConvert: (lead: LeadRead) => void }) {
      ...
      <DropdownMenuContent align="end">
        ...
        {isConverted && lead.converted_client_id && (
          <DropdownMenuItem asChild>
            <a href={`/app/clients/${lead.converted_client_id}`}>View Client</a>
          </DropdownMenuItem>
        )}
      </DropdownMenuContent>
    </DropdownMenu>
...
function buildLeadDataColumns(): ColumnDef<LeadRead>[] {
  return [
    {
      accessorKey: "name",
...
export const createLeadColumns = ({ onConvert }: LeadColumnsProps): ColumnDef<LeadRead>[] => [
  ...buildLeadDataColumns(),
  { id: "actions", cell: ({ row }) => <LeadActionsCell lead={row.original} onConvert={onConvert} /> },
];
