...
_s(RollingUpdates, "z6zrA5yuWQHEabDgZ9C0ZdALTiw=");
_c1 = RollingUpdates;
var _c, _c1;
...
function JobStatusPanel(param) {
    let { canStart, isStreaming, status, uploadProgress, onStart, updates } = param;
    _s();
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    showProgress && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        "generateDoc.useCallback[start]": async (param)=>{
            ...
            try {
                ...
                const totalBytes = templateFile.size + contextFiles.reduce({
                    "generateDoc.useCallback[start]": (sum, file)=>sum + file.size
                }["generateDoc.useCallback[start]"], 0);
                let uploadedBytes = 0;
                const bumpProgress = {
                    "generateDoc.useCallback[start].bumpProgress": (delta)=>{
                        uploadedBytes += delta;
                        const next = totalBytes === 0 ? 50 : Math.min(50, Math.round(uploadedBytes / totalBytes * 50));
                        setUploadProgress(next);
                    }
                }["generateDoc.useCallback[start].bumpProgress"];
                const put = {
                    "generateDoc.useCallback[start].put": (file, url, contentType)=>new Promise({
                            "generateDoc.useCallback[start].put": (resolve, reject)=>{
                                const xhr = new XMLHttpRequest();
                                let previousLoaded = 0;
                                xhr.upload.onprogress = ({
                                    "generateDoc.useCallback[start].put": (event)=>{
                                ...
                                xhr.onerror = ({
                                    "generateDoc.useCallback[start].put": ()=>reject(new Error("Failed to upload ".concat(file.name)))
                                })["generateDoc.useCallback[start].put"];
                                xhr.onload = ({
                                    "generateDoc.useCallback[start].put": ()=>{
                ...
                es.addEventListener("openaiUpload", {
                    "generateDoc.useCallback[start]": (event)=>{
                        const percent = Number(event.data);
                        if (Number.isFinite(percent)) {
                            setUploadProgress({
                                "generateDoc.useCallback[start]": (prev)=>Math.max(prev, 50 + percent / 2)
                            }["generateDoc.useCallback[start]"]);
                        }
                    }
                }["generateDoc.useCallback[start]"]);
...
_s(generateDoc, "1T7Vy/BBIihsCvxIW/CPYhxenGM=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
function Main(param) {
    ...
    const { jobId, updates, error, status, isStreaming, isCompleted, downloadUrl, uploadProgress, start, setError } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$src$2f$hooks$2f$generate$2d$doc$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateDoc"])();
...
_s(Main, "qhMbFCSkgpxrqPq0nmaMYbduZlg=");
_c = Main;
var _c;
