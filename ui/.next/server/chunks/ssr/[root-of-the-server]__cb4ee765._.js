...
function generateDoc() {
    ...
    const start = (0, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ({ templateFile, contextFiles, userId })=>{
        ...
        try {
            ...
            setStatus("uploading");
            const put = (file, url, contentType)=>fetch(url, {
                    method: "PUT",
                    headers: {
...
function Main({ userId: initialUserId }) {
    ...
    const { jobId, updates, error, status, isStreaming, isCompleted, downloadUrl, start, setError } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$src$2f$hooks$2f$generate$2d$doc$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["generateDoc"])();
    ...
    const canStart = (0, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>Boolean(templateFile) && Boolean(userId) && !isStreaming && !isCompleted, [
        isCompleted,
        isStreaming,
        templateFile,
        userId
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cb4ee765._.js.map