(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["chunks/70d1f_@auth0_nextjs-auth0_ab31d033._.js",
"[project]/docgen/ui/node_modules/@auth0/nextjs-auth0/dist/errors/index.js [middleware-edge] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/docgen/ui/node_modules/@auth0/nextjs-auth0/dist/utils/constants.js [middleware-edge] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/docgen/ui/node_modules/@auth0/nextjs-auth0/dist/utils/dpopUtils.js [middleware-edge] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/docgen/ui/node_modules/oauth4webapi/build/index.js [middleware-edge] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$utils$2f$constants$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/docgen/ui/node_modules/@auth0/nextjs-auth0/dist/utils/constants.js [middleware-edge] (ecmascript)");
;
;
;
/**
...
async function generateDpopKeyPair() {
    return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["generateKeyPair"])("ES256");
}
...
async function withDPoPNonceRetry(fn, config) {
     ...
     */ try {
        ...
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["isDPoPNonceError"])(error)) {
            // This is a DPoP nonce error, retry with delay and jitter
            await applyRetryDelay(config);
            // Retry the request - the DPoP handle automatically learned the nonce
            return await fn();
...
function validateKeyPairCompatibility(privateKey, publicKey) {
    ...
    try {
        ...
        const sign = (0, __TURBOPACK__imported__module__$5b$project$5d2f$__$5b$middleware$2d$edge$5d$__$28$unsupported__edge__import__$27$crypto$272c$__ecmascript$29$__["createSign"])("sha256");
        sign.update(testData);
        const signature = sign.sign(privateKey);
        // Verify with public key
        const verify = (0, __TURBOPACK__imported__module__$5b$project$5d2f$__$5b$middleware$2d$edge$5d$__$28$unsupported__edge__import__$27$crypto$272c$__ecmascript$29$__["createVerify"])("sha256");
...
function validateDpopConfiguration(options) {
    ...
    const clockTolerance = options.dpopOptions?.clockTolerance ?? (process.env.AUTH0_DPOP_CLOCK_TOLERANCE ? parseInt(process.env.AUTH0_DPOP_CLOCK_TOLERANCE, 10) : __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$utils$2f$constants$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["DEFAULT_DPOP_CLOCK_TOLERANCE"]);
    // Warn if clock tolerance exceeds recommended maximum (but don't enforce)
    if (clockTolerance > __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$utils$2f$constants$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["MAX_RECOMMENDED_DPOP_CLOCK_TOLERANCE"]) {
        const productionMaxTolerance = process.env.AUTH0_DPOP_CLOCK_TOLERANCE_MAX_PROD ? parseInt(process.env.AUTH0_DPOP_CLOCK_TOLERANCE_MAX_PROD, 10) : __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$utils$2f$constants$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["MAX_RECOMMENDED_DPOP_CLOCK_TOLERANCE"];
        if (("TURBOPACK compile-time value", "development") === "production" && clockTolerance > productionMaxTolerance) //TURBOPACK unreachable
        ;
        console.warn(`WARNING: clockTolerance of ${clockTolerance}s exceeds recommended maximum of ${__TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$utils$2f$constants$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["MAX_RECOMMENDED_DPOP_CLOCK_TOLERANCE"]}s. ` + "This may weaken DPoP security by allowing replay attacks within a wider time window. " + "Consider synchronizing server clocks using NTP instead of increasing tolerance.");
    }
    const dpopOptions = {
        clockSkew: options.dpopOptions?.clockSkew ?? (process.env.AUTH0_DPOP_CLOCK_SKEW ? parseInt(process.env.AUTH0_DPOP_CLOCK_SKEW, 10) : __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$utils$2f$constants$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["DEFAULT_DPOP_CLOCK_SKEW"]),
        clockTolerance,
        retry: {
            delay: options.dpopOptions?.retry?.delay ?? (process.env.AUTH0_RETRY_DELAY ? parseInt(process.env.AUTH0_RETRY_DELAY, 10) : __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$utils$2f$constants$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["DEFAULT_RETRY_DELAY"]),
            jitter: options.dpopOptions?.retry?.jitter ?? (process.env.AUTH0_RETRY_JITTER ? process.env.AUTH0_RETRY_JITTER === "true" : __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$utils$2f$constants$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["DEFAULT_RETRY_JITTER"])
        }
    };
    ...
    if (useDPoP) {
        ...
        if (privateKeyPem && publicKeyPem) {
            try {
                ...
                const privateKeyNodeJS = (0, __TURBOPACK__imported__module__$5b$project$5d2f$__$5b$middleware$2d$edge$5d$__$28$unsupported__edge__import__$27$crypto$272c$__ecmascript$29$__["createPrivateKey"])(privateKeyPem);
                const publicKeyNodeJS = (0, __TURBOPACK__imported__module__$5b$project$5d2f$__$5b$middleware$2d$edge$5d$__$28$unsupported__edge__import__$27$crypto$272c$__ecmascript$29$__["createPublicKey"])(publicKeyPem);
...
"[project]/docgen/ui/node_modules/@auth0/nextjs-auth0/dist/utils/request.js [middleware-edge] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/docgen/ui/node_modules/@auth0/nextjs-auth0/dist/utils/scope-helpers.js [middleware-edge] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$errors$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/docgen/ui/node_modules/@auth0/nextjs-auth0/dist/errors/index.js [middleware-edge] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$utils$2f$constants$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/docgen/ui/node_modules/@auth0/nextjs-auth0/dist/utils/constants.js [middleware-edge] (ecmascript)");
;
;
function ensureDefaultScope(authorizationParameters) {
    ...
    if (!authorizationParameters.scope) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$utils$2f$constants$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["DEFAULT_SCOPES"];
    }
    ...
    if (typeof authorizationParameters.scope === "object" && !getScopeForAudience(authorizationParameters.scope, authorizationParameters.audience)) {
        ...
        return {
            ...
            [audience]: __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$utils$2f$constants$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["DEFAULT_SCOPES"]
        };
    }
...
function getScopeForAudience(scope, audience) {
    ...
    if (!audience) {
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$errors$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["InvalidConfigurationError"]("When defining scope as a Map, an audience is required to look up the correct scope.");
    }
...
"[project]/docgen/ui/node_modules/@auth0/nextjs-auth0/dist/utils/token-set-helpers.js [middleware-edge] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/docgen/ui/node_modules/@auth0/nextjs-auth0/dist/utils/session-changes-helpers.js [middleware-edge] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ function isGlobalAudienceAndScope(tokenSet, session, globalScope, globalOptions) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$utils$2f$token$2d$set$2d$helpers$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["compareScopes"])(session.tokenSet.requestedScope ?? globalScope, tokenSet.requestedScope);
 ...
 */ function updateExistingAccessTokenWithMergedRequestedScopes(session, tokenSet, existingAccessTokenSet, audience) {
    return {
        accessTokens: session.accessTokens?.map((accessToken)=>accessToken === existingAccessTokenSet ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$utils$2f$token$2d$set$2d$helpers$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["accessTokenSetFromTokenSet"])({
                ...tokenSet,
                // Use the merged requested scopes (of both existing and new entry) for lookup purposes
                requestedScope: (0, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$utils$2f$token$2d$set$2d$helpers$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["mergeScopes"])(accessToken.requestedScope, tokenSet.requestedScope),
 ...
 */ function addNewAccessTokenSet(session, tokenSet, audience) {
    return {
        accessTokens: [
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$utils$2f$token$2d$set$2d$helpers$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["accessTokenSetFromTokenSet"])(tokenSet, {
                audience
            })
        ]
    };
 ...
 */ function updateExistingAccessTokenSet(session, tokenSet, existingAccessTokenSet, audience) {
    if (tokenSet.accessToken !== existingAccessTokenSet.accessToken) {
        return {
            accessTokens: session.accessTokens?.map((accessToken)=>accessToken === existingAccessTokenSet ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$utils$2f$token$2d$set$2d$helpers$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["accessTokenSetFromTokenSet"])(tokenSet, {
                    audience
                }) : accessToken)
        };
    }
 ...
 */ function handleSpecificAccessTokenUpdate(session, tokenSet, audience, scope) {
    ...
    let existingAccessTokenSet = (0, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$utils$2f$token$2d$set$2d$helpers$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["findAccessTokenSet"])(session, {
        scope,
        audience,
    ...
    if (!existingAccessTokenSet) {
        ...
        existingAccessTokenSet = (0, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$utils$2f$token$2d$set$2d$helpers$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["findAccessTokenSet"])(session, {
            scope: tokenSet.scope,
            audience,
            matchMode: "scope"
        });
...
function getSessionChangesAfterGetAccessToken(session, tokenSet, globalOptions) {
    ...
    const globalScope = (0, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$utils$2f$scope$2d$helpers$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["getScopeForAudience"])(globalOptions.scope, tokenSet.audience ?? globalOptions.audience);
...
"[project]/docgen/ui/node_modules/@auth0/nextjs-auth0/package.json (json)", ((__turbopack_context__) => {
...
"[project]/docgen/ui/node_modules/@auth0/nextjs-auth0/dist/types/token-vault.js [middleware-edge] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/docgen/ui/node_modules/@auth0/nextjs-auth0/dist/types/connected-accounts.js [middleware-edge] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/docgen/ui/node_modules/@auth0/nextjs-auth0/dist/types/index.js [middleware-edge] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([]);
var __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$types$2f$token$2d$vault$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/docgen/ui/node_modules/@auth0/nextjs-auth0/dist/types/token-vault.js [middleware-edge] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$types$2f$connected$2d$accounts$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/docgen/ui/node_modules/@auth0/nextjs-auth0/dist/types/connected-accounts.js [middleware-edge] (ecmascript)");
;
;
}),
"[project]/docgen/ui/node_modules/@auth0/nextjs-auth0/dist/utils/authorization-params-helpers.js [middleware-edge] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    Object.entries(mergedAuthorizationParams).forEach(([key, val])=>{
        if (!excludedParams || !excludedParams.includes(key) && val != null) {
            ...
            if (key === "scope" && typeof val === "object") {
                val = (0, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$utils$2f$scope$2d$helpers$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["getScopeForAudience"])(val, mergedAuthorizationParams.audience);
            }
...
"[project]/docgen/ui/node_modules/@auth0/nextjs-auth0/dist/utils/pathUtils.js [middleware-edge] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/docgen/ui/node_modules/@auth0/nextjs-auth0/dist/utils/proxy.js [middleware-edge] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/docgen/ui/node_modules/@auth0/nextjs-auth0/dist/utils/url-helpers.js [middleware-edge] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/docgen/ui/node_modules/@auth0/nextjs-auth0/dist/server/cookies.js [middleware-edge] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$edge$2d$runtime$2f$cookies$2f$dist$2f$index$2e$mjs__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/docgen/ui/node_modules/@edge-runtime/cookies/dist/index.mjs [middleware-edge] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$panva$2f$hkdf$2f$dist$2f$web$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/docgen/ui/node_modules/@panva/hkdf/dist/web/index.js [middleware-edge] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$jose$2f$dist$2f$webapi$2f$jwt$2f$encrypt$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/docgen/ui/node_modules/jose/dist/webapi/jwt/encrypt.js [middleware-edge] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$jose$2f$dist$2f$webapi$2f$jwt$2f$decrypt$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/docgen/ui/node_modules/jose/dist/webapi/jwt/decrypt.js [middleware-edge] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$jose$2f$dist$2f$webapi$2f$util$2f$base64url$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__base64url$3e$__ = __turbopack_context__.i("[project]/docgen/ui/node_modules/jose/dist/webapi/util/base64url.js [middleware-edge] (ecmascript) <export * as base64url>");
...
async function encrypt(payload, secret, expiration, additionalHeaders) {
    const encryptionSecret = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$panva$2f$hkdf$2f$dist$2f$web$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["hkdf"])(DIGEST, secret, "", ENCRYPTION_INFO, BYTE_LENGTH);
    const encryptedCookie = await new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$jose$2f$dist$2f$webapi$2f$jwt$2f$encrypt$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["EncryptJWT"](payload).setProtectedHeader({
        enc: ENC,
        alg: ALG,
        ...additionalHeaders
...
async function decrypt(cookieValue, secret, options) {
    try {
        const encryptionSecret = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$panva$2f$hkdf$2f$dist$2f$web$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["hkdf"])(DIGEST, secret, "", ENCRYPTION_INFO, BYTE_LENGTH);
        const cookie = await __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$jose$2f$dist$2f$webapi$2f$jwt$2f$decrypt$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["jwtDecrypt"](cookieValue, encryptionSecret, {
            ...options,
            ...{
                clockTolerance: 15
            }
 ...
 */ const signingSecret = (secret)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$panva$2f$hkdf$2f$dist$2f$web$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["hkdf"])("sha256", secret, "", "JWS Cookie Signing", BYTE_LENGTH);
async function verifySigned(k, v, secret) {
    ...
    const flattenedJWS = {
        protected: __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$jose$2f$dist$2f$webapi$2f$util$2f$base64url$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__base64url$3e$__["base64url"].encode(JSON.stringify({
            alg: "HS256",
            b64: false,
            crit: [
                "b64"
    ...
    try {
        await __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$jose$2f$dist$2f$webapi$2f$jws$2f$flattened$2f$verify$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["flattenedVerify"](flattenedJWS, key, {
            algorithms: [
                "HS256"
            ]
        });
...
async function sign(name, value, secret) {
    const key = await signingSecret(secret);
    const { signature } = await new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$jose$2f$dist$2f$webapi$2f$jws$2f$flattened$2f$sign$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["FlattenedSign"](new TextEncoder().encode(`${name}=${value}`)).setProtectedHeader({
        alg: "HS256",
        b64: false,
        crit: [
            "b64"
...
"[project]/docgen/ui/node_modules/@auth0/nextjs-auth0/dist/server/fetcher.js [middleware-edge] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class Fetcher {
    ...
    async internalFetchWithAuth(info, init, callbacks, getAccessTokenOptions) {
        ...
        try {
            ...
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["protectedResourceRequest"])(accessToken, request.method, new URL(request.url), request.headers, request.body, {
                ...this.config.httpOptions(),
                [__TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["customFetch"]]: (url, options)=>{
                    return this.config.fetch(url, options);
                },
                [__TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["allowInsecureRequests"]]: this.config.allowInsecureRequests || false,
                ...useDpop && {
            ...
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["isDPoPNonceError"])(error) && callbacks.onUseDpopNonceError) {
        ...
        const callbacks = {
            onUseDpopNonceError: async ()=>{
                ...
                try {
                    ...
                    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["isDPoPNonceError"])(retryError)) {
...
"[project]/docgen/ui/node_modules/@auth0/nextjs-auth0/dist/server/user.js [middleware-edge] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/docgen/ui/node_modules/@auth0/nextjs-auth0/dist/server/auth-client.js [middleware-edge] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/docgen/ui/node_modules/next/server.js [middleware-edge] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$jose$2f$dist$2f$webapi$2f$jwk$2f$thumbprint$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/docgen/ui/node_modules/jose/dist/webapi/jwk/thumbprint.js [middleware-edge] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$jose$2f$dist$2f$webapi$2f$jwks$2f$remote$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/docgen/ui/node_modules/jose/dist/webapi/jwks/remote.js [middleware-edge] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$jose$2f$dist$2f$webapi$2f$jwt$2f$verify$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/docgen/ui/node_modules/jose/dist/webapi/jwt/verify.js [middleware-edge] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/docgen/ui/node_modules/oauth4webapi/build/index.js [middleware-edge] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$openid$2d$client$2f$build$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/docgen/ui/node_modules/openid-client/build/index.js [middleware-edge] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$package$2e$json__$28$json$29$__ = __turbopack_context__.i("[project]/docgen/ui/node_modules/@auth0/nextjs-auth0/package.json (json)");
var __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$errors$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/docgen/ui/node_modules/@auth0/nextjs-auth0/dist/errors/index.js [middleware-edge] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$types$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/docgen/ui/node_modules/@auth0/nextjs-auth0/dist/types/index.js [middleware-edge] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$types$2f$connected$2d$accounts$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/docgen/ui/node_modules/@auth0/nextjs-auth0/dist/types/connected-accounts.js [middleware-edge] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$types$2f$token$2d$vault$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/docgen/ui/node_modules/@auth0/nextjs-auth0/dist/types/token-vault.js [middleware-edge] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$utils$2f$authorization$2d$params$2d$helpers$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/docgen/ui/node_modules/@auth0/nextjs-auth0/dist/utils/authorization-params-helpers.js [middleware-edge] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$utils$2f$constants$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/docgen/ui/node_modules/@auth0/nextjs-auth0/dist/utils/constants.js [middleware-edge] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$utils$2f$dpopUtils$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/docgen/ui/node_modules/@auth0/nextjs-auth0/dist/utils/dpopUtils.js [middleware-edge] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$utils$2f$pathUtils$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/docgen/ui/node_modules/@auth0/nextjs-auth0/dist/utils/pathUtils.js [middleware-edge] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$utils$2f$proxy$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/docgen/ui/node_modules/@auth0/nextjs-auth0/dist/utils/proxy.js [middleware-edge] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$utils$2f$scope$2d$helpers$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/docgen/ui/node_modules/@auth0/nextjs-auth0/dist/utils/scope-helpers.js [middleware-edge] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$utils$2f$session$2d$changes$2d$helpers$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/docgen/ui/node_modules/@auth0/nextjs-auth0/dist/utils/session-changes-helpers.js [middleware-edge] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$utils$2f$token$2d$set$2d$helpers$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/docgen/ui/node_modules/@auth0/nextjs-auth0/dist/utils/token-set-helpers.js [middleware-edge] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$utils$2f$url$2d$helpers$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/docgen/ui/node_modules/@auth0/nextjs-auth0/dist/utils/url-helpers.js [middleware-edge] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$cookies$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/docgen/ui/node_modules/@auth0/nextjs-auth0/dist/server/cookies.js [middleware-edge] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$fetcher$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/docgen/ui/node_modules/@auth0/nextjs-auth0/dist/server/fetcher.js [middleware-edge] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$user$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/docgen/ui/node_modules/@auth0/nextjs-auth0/dist/server/user.js [middleware-edge] (ecmascript)");
...
function createRouteUrl(path, baseUrl) {
    return new URL((0, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$utils$2f$pathUtils$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["ensureNoLeadingSlash"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$utils$2f$pathUtils$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["normalizeWithBasePath"])(path)), (0, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$utils$2f$pathUtils$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["ensureTrailingSlash"])(baseUrl));
}
class AuthClient {
    constructor(options){
        ...
        this.httpOptions = ()=>{
            ...
            if (enableTelemetry) {
                ...
                const version = __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$package$2e$json__$28$json$29$__["default"].version;
        ...
        if (options.dpopOptions) {
            if (typeof options.dpopOptions.clockSkew === "number") {
                this.clientMetadata[__TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["clockSkew"]] = options.dpopOptions.clockSkew;
            }
            if (typeof options.dpopOptions.clockTolerance === "number") {
                this.clientMetadata[__TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["clockTolerance"]] = options.dpopOptions.clockTolerance;
            }
        }
        ...
        this.authorizationParameters = options.authorizationParameters || {
            scope: __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$utils$2f$constants$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["DEFAULT_SCOPES"]
        };
        ...
        this.authorizationParameters.scope = (0, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$utils$2f$scope$2d$helpers$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["ensureDefaultScope"])(this.authorizationParameters);
        const scope = (0, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$utils$2f$scope$2d$helpers$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["getScopeForAudience"])(this.authorizationParameters.scope, this.authorizationParameters.audience)?.split(" ").map((s)=>s.trim());
    ...
    async handler(req) {
        ...
        const sanitizedPathname = (0, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$utils$2f$pathUtils$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["removeTrailingSlash"])(pathname);
        ...
        if (method === "GET" && sanitizedPathname === this.routes.login) {
            ...
            const res = __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"].next();
            ...
            if (session) {
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$cookies$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__$3c$locals$3e$__["addCacheControlHeadersForSession"])(res);
            }
            return res;
        }
    }
    async startInteractiveLogin(options = {}) {
        ...
        if (options.returnTo) {
            ...
            const sanitizedReturnTo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$utils$2f$url$2d$helpers$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["toSafeRedirect"])(options.returnTo, safeBaseUrl);
        ...
        const codeVerifier = __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["generateRandomCodeVerifier"]();
        const codeChallenge = await __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["calculatePKCECodeChallenge"](codeVerifier);
        const state = __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["generateRandomState"]();
        const nonce = __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["generateRandomNonce"]();
        ...
        const authorizationParams = (0, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$utils$2f$authorization$2d$params$2d$helpers$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["mergeAuthorizationParamsIntoSearchParams"])(this.authorizationParameters, options.authorizationParameters, INTERNAL_AUTHORIZE_PARAMS);
        authorizationParams.set("client_id", this.clientMetadata.client_id);
        authorizationParams.set("redirect_uri", redirectUri.toString());
        authorizationParams.set("response_type", __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$types$2f$connected$2d$accounts$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["RESPONSE_TYPES"].CODE);
        ...
        if (this.dpopKeyPair) {
            try {
                const publicKeyJwk = await __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$jose$2f$dist$2f$webapi$2f$key$2f$export$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["exportJWK"](this.dpopKeyPair.publicKey);
                const dpopJkt = await __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$jose$2f$dist$2f$webapi$2f$jwk$2f$thumbprint$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["calculateJwkThumbprint"](publicKeyJwk);
                authorizationParams.set("dpop_jkt", dpopJkt);
            } catch (error) {
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$errors$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["DPoPError"](__TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$errors$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["DPoPErrorCode"].DPOP_JKT_CALCULATION_FAILED, "DPoP is enabled but failed to calculate key thumbprint (dpop_jkt). " + "This is required for secure DPoP binding. Please check your key configuration.", error instanceof Error ? error : undefined);
            }
        }
        ...
        const transactionState = {
            ...
            codeVerifier,
            responseType: __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$types$2f$connected$2d$accounts$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["RESPONSE_TYPES"].CODE,
            state,
            returnTo,
        ...
        if (error) {
            return new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"]("An error occurred while trying to initiate the login request.", {
                status: 500
            });
        }
        // Set response and save transaction
        const res = __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"].redirect(authorizationUrl.toString());
    ...
    async handleLogout(req) {
        ...
        if (discoveryError) {
            ...
            const errorResponse = new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"]("An error occurred while trying to initiate the logout request.", {
                status: 500
            });
        ...
        const createV2LogoutResponse = ()=>{
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"].redirect(url);
        };
        ...
        if (this.logoutStrategy === "v2") {
            ...
            if (!authorizationServerMetadata.end_session_endpoint) {
                ...
                const errorResponse = new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"]("OIDC RP-Initiated Logout is not supported by the authorization server. Enable it or use a different logout strategy.", {
                    status: 500
                });
                await this.sessionStore.delete(req.cookies, errorResponse.cookies);
                await this.transactionStore.deleteAll(req.cookies, errorResponse.cookies);
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$cookies$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__$3c$locals$3e$__["addCacheControlHeadersForSession"])(logoutResponse);
    ...
    async handleCallback(req) {
        ...
        if (!state) {
            return this.handleCallbackError(new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$errors$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["MissingStateError"](), {}, req);
        }
        const transactionStateCookie = await this.transactionStore.get(req.cookies, state);
        if (!transactionStateCookie) {
            return this.onCallback(new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$errors$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["InvalidStateError"](), {}, null);
        }
        ...
        if (transactionState.responseType === __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$types$2f$connected$2d$accounts$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["RESPONSE_TYPES"].CONNECT_CODE) {
            const session = await this.sessionStore.get(req.cookies);
            if (!session) {
                return this.handleCallbackError(new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$errors$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["ConnectAccountError"]({
                    code: __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$errors$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["ConnectAccountErrorCodes"].MISSING_SESSION,
        ...
        let codeGrantParams;
        try {
            codeGrantParams = __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["validateAuthResponse"](authorizationServerMetadata, this.clientMetadata, req.nextUrl.searchParams, transactionState.state);
        } catch (e) {
            return this.handleCallbackError(new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$errors$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["AuthorizationError"]({
                cause: new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$errors$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["OAuth2Error"]({
                    code: e.error,
        ...
        try {
            ...
            const dpopHandle = this.useDPoP && this.dpopKeyPair ? __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["DPoP"](this.clientMetadata, this.dpopKeyPair) : undefined;
            authorizationCodeGrantRequestCall = async ()=>__TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["authorizationCodeGrantRequest"](authorizationServerMetadata, this.clientMetadata, await this.getClientAuth(), codeGrantParams, redirectUri.toString(), transactionState.codeVerifier, {
                    ...this.httpOptions(),
                    [__TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["customFetch"]]: this.fetch,
                    [__TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["allowInsecureRequests"]]: this.allowInsecureRequests,
                    ...dpopHandle && {
                        DPoP: dpopHandle
                    }
                });
            ...
            codeGrantResponse = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$utils$2f$dpopUtils$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["withDPoPNonceRetry"])(authorizationCodeGrantRequestCall, {
                isDPoPEnabled: !!dpopHandle,
                ...this.dpopOptions?.retry
            });
        } catch (e) {
            return this.handleCallbackError(new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$errors$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["AuthorizationCodeGrantRequestError"](e.message), onCallbackCtx, req, state);
        }
        let oidcRes;
        try {
            ...
            oidcRes = await __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["processAuthorizationCodeResponse"](authorizationServerMetadata, this.clientMetadata, codeGrantResponse, {
                expectedNonce: transactionState.nonce,
                maxAge: transactionState.maxAge,
                requireIdToken: true
            });
        } catch (e) {
            return this.handleCallbackError(new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$errors$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["AuthorizationCodeGrantError"]({
                cause: new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$errors$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["OAuth2Error"]({
                    code: e.error,
                    message: e.error_description
                })
        ...
        const idTokenClaims = __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["getValidatedIdTokenClaims"](oidcRes);
        let session = {
            user: idTokenClaims,
            tokenSet: {
    ...
    async handleProfile(req) {
        ...
        if (!session) {
            if (this.noContentProfileResponseWhenUnauthenticated) {
                return new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"](null, {
                    status: 204
                });
            }
            return new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"](null, {
        ...
        const res = __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"].json(session?.user);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$cookies$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__$3c$locals$3e$__["addCacheControlHeadersForSession"])(res);
        return res;
    }
    async handleAccessToken(req) {
        ...
        if (!session) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: {
                    message: "The user does not have an active session.",
                    code: __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$errors$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["AccessTokenErrorCode"].MISSING_SESSION
                }
            }, {
                status: 401
            });
        ...
        const res = __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"].json({
    ...
    async handleBackChannelLogout(req) {
        if (!this.sessionStore.store) {
            return new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"]("A session data store is not configured.", {
                status: 500
            });
        }
        if (!this.sessionStore.store.deleteByLogoutToken) {
            return new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"]("Back-channel logout is not supported by the session data store.", {
                status: 500
            });
        }
        ...
        if (!logoutToken) {
            return new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"]("Missing `logout_token` in the request body.", {
                status: 400
            });
        }
        const [error, logoutTokenClaims] = await this.verifyLogoutToken(logoutToken);
        if (error) {
            return new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"](error.message, {
                status: 400
            });
        }
    ...
    async handleConnectAccount(req) {
        ...
        if (!connection) {
            return new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"]("A connection is required.", {
                status: 400
            });
        }
        if (!session) {
            return new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"]("The user does not have an active session.", {
                status: 401
            });
        }
        ...
        if (getTokenSetError) {
            return new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"]("Failed to retrieve a connected account access token.", {
                status: 401
            });
        }
        ...
        if (connectAccountError) {
            return new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"](connectAccountError.message, {
     ...
     */ async getTokenSet(sessionData, options = {}) {
        ...
        const scope = (0, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$utils$2f$token$2d$set$2d$helpers$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["mergeScopes"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$utils$2f$scope$2d$helpers$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["getScopeForAudience"])(this.authorizationParameters.scope, options.audience ?? this.authorizationParameters.audience), options.scope);
        ...
        if (!tokenSet.refreshToken && !tokenSet.accessToken) {
            return [
                new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$errors$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["AccessTokenError"](__TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$errors$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["AccessTokenErrorCode"].MISSING_REFRESH_TOKEN, "No access token found and a refresh token was not provided. The user needs to re-authenticate."),
                null
            ];
        }
        ...
        if (!tokenSet.refreshToken && tokenSet.accessToken && tokenSet.expiresAt && tokenSet.expiresAt <= Date.now() / 1000) {
            return [
                new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$errors$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["AccessTokenError"](__TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$errors$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["AccessTokenErrorCode"].MISSING_REFRESH_TOKEN, "The access token has expired and a refresh token was not provided. The user needs to re-authenticate."),
                null
            ];
        }
    ...
    async backchannelAuthentication(options) {
        ...
        if (!authorizationServerMetadata.backchannel_authentication_endpoint) {
            return [
                new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$errors$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["BackchannelAuthenticationNotSupportedError"](),
                null
            ];
        }
        // If provided on both sides, this does not merge the scope property,
        ...
        if (!authorizationParams.get("scope")) {
            authorizationParams.set("scope", __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$utils$2f$constants$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["DEFAULT_SCOPES"]);
        }
        authorizationParams.set("client_id", this.clientMetadata.client_id);
        ...
        try {
            const backchannelAuthenticationResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$openid$2d$client$2f$build$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__$3c$locals$3e$__["initiateBackchannelAuthentication"](openidClientConfig, authorizationParams);
            const tokenEndpointResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$openid$2d$client$2f$build$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__$3c$locals$3e$__["pollBackchannelAuthenticationGrant"](openidClientConfig, backchannelAuthenticationResponse);
            ...
            return [
                new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$errors$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["BackchannelAuthenticationError"]({
                    cause: new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$errors$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["OAuth2Error"]({
                        code: e.error,
                        message: e.error_description
                    })
    ...
    async discoverAuthorizationServerMetadata() {
        ...
        try {
            const authorizationServerMetadata = await __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["discoveryRequest"](issuer, {
                ...this.httpOptions(),
                [__TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["customFetch"]]: this.fetch,
                [__TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["allowInsecureRequests"]]: this.allowInsecureRequests
            }).then((response)=>__TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["processDiscoveryResponse"](issuer, response));
            ...
            return [
                new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$errors$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["DiscoveryError"]("Discovery failed for the OpenID Connect configuration."),
                null
            ];
        }
    }
    async defaultOnCallback(error, ctx) {
        ...
        const res = __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"].redirect(createRouteUrl(ctx.returnTo || "/", this.appBaseUrl));
        return res;
    }
    /**
    ...
    async verifyLogoutToken(logoutToken) {
        ...
        const keyInput = __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$jose$2f$dist$2f$webapi$2f$jwks$2f$remote$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["createRemoteJWKSet"](new URL(authorizationServerMetadata.jwks_uri), {
            [__TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$jose$2f$dist$2f$webapi$2f$jwks$2f$remote$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["jwksCache"]]: this.jwksCache
        });
        const { payload } = await __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$jose$2f$dist$2f$webapi$2f$jwt$2f$verify$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["jwtVerify"](logoutToken, keyInput, {
        ...
        if (!("sid" in payload) && !("sub" in payload)) {
            return [
                new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$errors$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["BackchannelLogoutError"]('either "sid" or "sub" (or both) claims must be present'),
                null
            ];
        }
        if ("sid" in payload && typeof payload.sid !== "string") {
            return [
                new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$errors$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["BackchannelLogoutError"]('"sid" claim must be a string'),
                null
            ];
        }
        if ("sub" in payload && typeof payload.sub !== "string") {
            return [
                new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$errors$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["BackchannelLogoutError"]('"sub" claim must be a string'),
                null
            ];
        }
        if ("nonce" in payload) {
            return [
                new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$errors$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["BackchannelLogoutError"]('"nonce" claim is prohibited'),
                null
            ];
        }
        if (!("events" in payload)) {
            return [
                new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$errors$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["BackchannelLogoutError"]('"events" claim is missing'),
                null
            ];
        }
        if (typeof payload.events !== "object" || payload.events === null) {
            return [
                new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$errors$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["BackchannelLogoutError"]('"events" claim must be an object'),
                null
            ];
        }
        if (!("http://schemas.openid.net/event/backchannel-logout" in payload.events)) {
            return [
                new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$errors$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["BackchannelLogoutError"]('"http://schemas.openid.net/event/backchannel-logout" member is missing in the "events" claim'),
                null
            ];
        }
        if (typeof payload.events["http://schemas.openid.net/event/backchannel-logout"] !== "object") {
            return [
                new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$errors$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["BackchannelLogoutError"]('"http://schemas.openid.net/event/backchannel-logout" member in the "events" claim must be an object'),
                null
            ];
        }
        return [
    ...
    async authorizationUrl(params) {
        ...
        if (this.pushedAuthorizationRequests) {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["pushedAuthorizationRequest"](authorizationServerMetadata, this.clientMetadata, await this.getClientAuth(), params, {
                ...this.httpOptions(),
                [__TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["customFetch"]]: this.fetch,
                [__TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["allowInsecureRequests"]]: this.allowInsecureRequests
            });
            let parRes;
            try {
                parRes = await __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["processPushedAuthorizationResponse"](authorizationServerMetadata, this.clientMetadata, response);
            } catch (e) {
                return [
                    new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$errors$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["AuthorizationError"]({
                        cause: new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$errors$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["OAuth2Error"]({
                            code: e.error,
                            message: e.error_description
                        }),
    ...
    async getClientAuth() {
        ...
        if (clientPrivateKey && typeof clientPrivateKey === "string") {
            clientPrivateKey = await __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$jose$2f$dist$2f$webapi$2f$key$2f$import$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["importPKCS8"](clientPrivateKey, this.clientAssertionSigningAlg);
        }
        return clientPrivateKey ? __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["PrivateKeyJwt"](clientPrivateKey) : __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["ClientSecretPost"](this.clientSecret);
    }
    get issuer() {
     ...
     */ async getConnectionTokenSet(tokenSet, connectionTokenSet, options) {
        ...
        if (!tokenSet.refreshToken && (!connectionTokenSet || connectionTokenSet.expiresAt <= Date.now() / 1000)) {
            return [
                new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$errors$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["AccessTokenForConnectionError"](__TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$errors$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["AccessTokenForConnectionErrorCode"].MISSING_REFRESH_TOKEN, "A refresh token was not present, Connection Access Token requires a refresh token. The user needs to re-authenticate."),
                null
            ];
        }
        ...
        if (tokenSet.refreshToken && (!connectionTokenSet || connectionTokenSet.expiresAt <= Date.now() / 1000)) {
            ...
            const subjectTokenType = options.subject_token_type ?? __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$types$2f$token$2d$vault$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["SUBJECT_TOKEN_TYPES"].SUBJECT_TYPE_REFRESH_TOKEN;
            const subjectToken = subjectTokenType === __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$types$2f$token$2d$vault$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["SUBJECT_TOKEN_TYPES"].SUBJECT_TYPE_ACCESS_TOKEN ? tokenSet.accessToken : tokenSet.refreshToken;
            ...
            // the DPoP-Nonce header across multiple attempts.
            const dpopHandle = this.useDPoP && this.dpopKeyPair ? __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["DPoP"](this.clientMetadata, this.dpopKeyPair) : undefined;
            const genericTokenEndpointRequestCall = async ()=>__TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["genericTokenEndpointRequest"](authorizationServerMetadata, this.clientMetadata, await this.getClientAuth(), GRANT_TYPE_FEDERATED_CONNECTION_ACCESS_TOKEN, params, {
                    [__TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["customFetch"]]: this.fetch,
                    [__TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["allowInsecureRequests"]]: this.allowInsecureRequests,
                    ...dpopHandle && {
                        DPoP: dpopHandle
            ...
            const processGenericTokenEndpointResponseCall = async ()=>{
                ...
                return __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["processGenericTokenEndpointResponse"](authorizationServerMetadata, this.clientMetadata, httpResponse);
            };
            let tokenEndpointResponse;
            try {
                tokenEndpointResponse = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$utils$2f$dpopUtils$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["withDPoPNonceRetry"])(processGenericTokenEndpointResponseCall, {
                    isDPoPEnabled: !!(this.useDPoP && this.dpopKeyPair),
                    ...this.dpopOptions?.retry
                });
            } catch (err) {
                return [
                    new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$errors$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["AccessTokenForConnectionError"](__TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$errors$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["AccessTokenForConnectionErrorCode"].FAILED_TO_EXCHANGE, "There was an error trying to exchange the refresh token for a connection access token.", new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$errors$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["OAuth2Error"]({
                        code: err.error,
     ...
     */ async finalizeSession(session, idToken) {
        if (this.beforeSessionSaved) {
            ...
            session.user = (0, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$user$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["filterDefaultIdTokenClaims"])(session.user);
        }
        return session;
    }
    /**
     ...
     */ async connectAccount(options) {
        ...
        const transactionState = {
            codeVerifier,
            responseType: __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$types$2f$connected$2d$accounts$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["RESPONSE_TYPES"].CONNECT_CODE,
            state,
            returnTo,
            authSession: connectAccountResponse.authSession
        };
        const res = __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"].redirect(`${connectAccountResponse.connectUri}?ticket=${encodeURIComponent(connectAccountResponse.connectParams.ticket)}`);
        await this.transactionStore.save(res.cookies, transactionState);
        return [
            null,
            res
    ...
    async createConnectAccountTicket(options) {
        try {
            ...
            if (!res.ok) {
                return buildConnectAccountErrorResponse(res, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$errors$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["ConnectAccountErrorCodes"].FAILED_TO_INITIATE);
            }
            ...
            if (e instanceof __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$errors$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["DPoPError"]) {
                message = e.message;
            }
            return [
                new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$errors$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["ConnectAccountError"]({
                    code: __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$errors$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["ConnectAccountErrorCodes"].FAILED_TO_INITIATE,
                    message: message
                }),
                null
            ];
    ...
    async completeConnectAccount(options) {
        ...
        try {
            ...
            if (!res.ok) {
                return buildConnectAccountErrorResponse(res, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$errors$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["ConnectAccountErrorCodes"].FAILED_TO_COMPLETE);
            }
            ...
            return [
                new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$errors$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["ConnectAccountError"]({
                    code: __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$errors$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["ConnectAccountErrorCodes"].FAILED_TO_COMPLETE,
    ...
    async getOpenIdClientConfig() {
        ...
        const openidClientConfig = new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$openid$2d$client$2f$build$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__$3c$locals$3e$__["Configuration"](authorizationServerMetadata, this.clientMetadata.client_id, {}, await this.getClientAuth());
        const httpOpts = this.httpOptions();
        const telemetryHeaders = new Headers(httpOpts.headers);
        openidClientConfig[__TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$openid$2d$client$2f$build$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__$3c$locals$3e$__["customFetch"]] = (...args)=>{
        ...
        if (this.allowInsecureRequests) {
            __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$openid$2d$client$2f$build$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__$3c$locals$3e$__["allowInsecureRequests"](openidClientConfig);
        }
        return [
            null,
            openidClientConfig
     ...
     */ async fetcherFactory(options) {
        if (this.useDPoP && !this.dpopKeyPair) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$errors$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["DPoPError"](__TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$errors$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["DPoPErrorCode"].DPOP_CONFIGURATION_ERROR, "DPoP is enabled but no keypair is configured.");
        }
        ...
        const fetcherConfig = {
            ...
            dpopHandle: this.useDPoP && (options.useDPoP ?? true) ? __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["DPoP"](this.clientMetadata, this.dpopKeyPair) : undefined,
        ...
        return new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$fetcher$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["Fetcher"](fetcherConfig, fetcherHooks);
    }
}
_AuthClient_instances = new WeakSet(), _AuthClient_getTokenSetFromSession = function _AuthClient_getTokenSetFromSession(session, options) {
    ...
    const isScopeTheGlobalScope = !scope || (0, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$utils$2f$token$2d$set$2d$helpers$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["compareScopes"])(tokenSet.requestedScope || (0, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$utils$2f$scope$2d$helpers$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["getScopeForAudience"])(this.authorizationParameters.scope, audience), scope);
    ...
    // If there is no audience, we cannot find the correct access token in the array
    if (audience) {
        accessTokenSet = (0, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$utils$2f$token$2d$set$2d$helpers$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["findAccessTokenSet"])(session, {
            scope,
            audience
        });
    }
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$utils$2f$token$2d$set$2d$helpers$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["tokenSetFromAccessTokenSet"])(accessTokenSet, tokenSet);
 ...
 */ async function _AuthClient_handlePreflight(req, options) {
    const headers = (0, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$utils$2f$proxy$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["buildForwardedRequestHeaders"])(req);
    const targetUrl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$utils$2f$proxy$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["transformTargetUrl"])(req, options);
    ...
    try {
        ...
        return new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"](null, {
            ...
            headers: (0, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$utils$2f$proxy$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["buildForwardedResponseHeaders"])(preflightResponse)
        });
    } catch (error) {
        // If preflight fails, return 500
        return new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"](error.cause || error.message || "Preflight request failed", {
            status: 500
        });
    }
 ...
 */ async function _AuthClient_handleProxy(req, options) {
    ...
    try {
        ...
        const res = new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"](response.body, {
            status: response.status,
            statusText: response.statusText,
            headers: (0, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$utils$2f$proxy$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["buildForwardedResponseHeaders"])(response)
        });
        ...
        if (e instanceof __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$errors$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["AccessTokenError"] && e.code === __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$errors$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["AccessTokenErrorCode"].MISSING_REFRESH_TOKEN) {
            return new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"](e.message, {
                status: 401
            });
        }
        // Generic error handling for other errors
        return new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"](e.cause || e.message || "An error occurred while proxying the request.", {
            status: 500
        });
    }
 ...
 */ async function _AuthClient_updateSessionAfterTokenRetrieval(req, res, session, tokenSetResponse) {
    const sessionChanges = (0, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$utils$2f$session$2d$changes$2d$helpers$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["getSessionChangesAfterGetAccessToken"])(session, tokenSetResponse.tokenSet, {
        scope: this.authorizationParameters?.scope ?? __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$utils$2f$constants$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["DEFAULT_SCOPES"],
 ...
 */ async function _AuthClient_refreshTokenSet(tokenSet, options) {
    ...
    // the DPoP-Nonce header across multiple attempts.
    const dpopHandle = this.useDPoP && this.dpopKeyPair ? __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["DPoP"](this.clientMetadata, this.dpopKeyPair) : undefined;
    const refreshTokenGrantRequestCall = async ()=>__TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["refreshTokenGrantRequest"](authorizationServerMetadata, this.clientMetadata, await this.getClientAuth(), tokenSet.refreshToken, {
            ...this.httpOptions(),
            [__TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["customFetch"]]: this.fetch,
            [__TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["allowInsecureRequests"]]: this.allowInsecureRequests,
    ...
    const processRefreshTokenResponseCall = (response)=>__TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["processRefreshTokenResponse"](authorizationServerMetadata, this.clientMetadata, response);
    let oauthRes;
    try {
        oauthRes = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$utils$2f$dpopUtils$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["withDPoPNonceRetry"])(async ()=>{
        ...
        return [
            new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$errors$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["AccessTokenError"](__TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$errors$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["AccessTokenErrorCode"].FAILED_TO_REFRESH_TOKEN, "The access token has expired and there was an error while trying to refresh it.", new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$errors$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["OAuth2Error"]({
                code: e.error,
                message: e.error_description
            })),
            null
    ...
    const idTokenClaims = __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$oauth4webapi$2f$build$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["getValidatedIdTokenClaims"](oauthRes);
...
async function buildConnectAccountErrorResponse(res, errorCode) {
    const actionVerb = errorCode === __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$errors$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["ConnectAccountErrorCodes"].FAILED_TO_INITIATE ? "initiate" : "complete";
    try {
        ...
        return [
            new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$errors$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["ConnectAccountError"]({
                ...
                cause: new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$errors$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["MyAccountApiError"]({
                    type: errorBody.type,
...
"[project]/docgen/ui/node_modules/@auth0/nextjs-auth0/dist/server/next-compat.js [middleware-edge] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function toNextRequest(input) {
    if (input instanceof __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextRequest"]) {
        return input;
    }
    ...
    return new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextRequest"](input.url, init);
}
function toNextResponse(res) {
    if (res instanceof __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"]) {
        return res;
    }
    const headers = new Headers(res.headers);
    const nextRes = new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"](res.body, {
        status: res.status,
...
"[project]/docgen/ui/node_modules/@auth0/nextjs-auth0/dist/server/helpers/with-api-auth-required.js [middleware-edge] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/docgen/ui/node_modules/next/server.js [middleware-edge] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$next$2d$compat$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/docgen/ui/node_modules/@auth0/nextjs-auth0/dist/server/next-compat.js [middleware-edge] (ecmascript)");
;
;
const appRouteHandlerFactory = (client)=>(apiRoute)=>async (req, params)=>{
            const nextReq = req instanceof Request ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$next$2d$compat$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["toNextRequest"])(req) : req;
            ...
            const nextApiRes = apiRes instanceof __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"] ? apiRes : new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"](apiRes.body, apiRes);
            return nextApiRes;
        };
...
"[project]/docgen/ui/node_modules/@auth0/nextjs-auth0/dist/server/helpers/with-page-auth-required.js [middleware-edge] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const appRouteHandlerFactory = (client, config)=>(handler, opts = {})=>async (params)=>{
            ...
            if (!session?.user) {
                ...
                const { redirect } = await Promise.resolve().then(()=>__turbopack_context__.i("[project]/docgen/ui/node_modules/next/navigation.js [middleware-edge] (ecmascript)"));
...
"[project]/docgen/ui/node_modules/@auth0/nextjs-auth0/dist/server/session/abstract-session-store.js [middleware-edge] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/docgen/ui/node_modules/@auth0/nextjs-auth0/dist/server/session/normalize-session.js [middleware-edge] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/docgen/ui/node_modules/@auth0/nextjs-auth0/dist/server/session/stateful-session-store.js [middleware-edge] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$cookies$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/docgen/ui/node_modules/@auth0/nextjs-auth0/dist/server/cookies.js [middleware-edge] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$session$2f$abstract$2d$session$2d$store$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/docgen/ui/node_modules/@auth0/nextjs-auth0/dist/server/session/abstract-session-store.js [middleware-edge] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$session$2f$normalize$2d$session$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/docgen/ui/node_modules/@auth0/nextjs-auth0/dist/server/session/normalize-session.js [middleware-edge] (ecmascript)");
;
;
;
const generateId = ()=>{
...
class StatefulSessionStore extends __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$session$2f$abstract$2d$session$2d$store$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["AbstractSessionStore"] {
    ...
    async get(reqCookies) {
        const cookie = reqCookies.get(this.sessionCookieName) || reqCookies.get(__TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$session$2f$normalize$2d$session$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["LEGACY_COOKIE_NAME"]);
        ...
        let sessionId = null;
        try {
            const sessionCookie = await __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$cookies$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__$3c$locals$3e$__["decrypt"](cookie.value, this.secret);
            ...
            if (e.code === "ERR_JWE_INVALID") {
                const legacySessionId = await __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$cookies$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__$3c$locals$3e$__["verifySigned"](cookie.name, cookie.value, this.secret);
                if (!legacySessionId) {
                    return null;
                }
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$session$2f$normalize$2d$session$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["normalizeStatefulSession"])(session);
    }
    async set(reqCookies, resCookies, session, isNew = false) {
        ...
        if (cookieValue) {
            const sessionCookie = await __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$cookies$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__$3c$locals$3e$__["decrypt"](cookieValue, this.secret);
            if (sessionCookie) {
                sessionId = sessionCookie.payload.id;
            }
        }
        ...
        const jwe = await __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$cookies$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__$3c$locals$3e$__["encrypt"]({
            id: sessionId
        ...
        if (this.sessionCookieName !== __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$session$2f$normalize$2d$session$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["LEGACY_COOKIE_NAME"] && reqCookies.has(__TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$session$2f$normalize$2d$session$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["LEGACY_COOKIE_NAME"])) {
            __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$cookies$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__$3c$locals$3e$__["deleteCookie"](resCookies, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$session$2f$normalize$2d$session$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["LEGACY_COOKIE_NAME"], {
    ...
    async delete(reqCookies, resCookies) {
        const cookieValue = reqCookies.get(this.sessionCookieName)?.value;
        __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$cookies$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__$3c$locals$3e$__["deleteCookie"](resCookies, this.sessionCookieName, {
            domain: this.cookieConfig.domain,
            path: this.cookieConfig.path
        });
        if (!cookieValue) {
        ...
        const session = await __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$cookies$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__$3c$locals$3e$__["decrypt"](cookieValue, this.secret);
        if (session) {
...
"[project]/docgen/ui/node_modules/@auth0/nextjs-auth0/dist/server/session/stateless-session-store.js [middleware-edge] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
class StatelessSessionStore extends __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$session$2f$abstract$2d$session$2d$store$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["AbstractSessionStore"] {
    ...
    async get(reqCookies) {
        const cookieValue = __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$cookies$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getChunkedCookie"](this.sessionCookieName, reqCookies) ?? __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$cookies$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getChunkedCookie"](__TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$session$2f$normalize$2d$session$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["LEGACY_COOKIE_NAME"], reqCookies, true);
        if (!cookieValue) {
            return null;
        }
        const originalSession = await __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$cookies$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__$3c$locals$3e$__["decrypt"](cookieValue, this.secret);
        if (!originalSession) {
            return null;
        }
        const normalizedStatelessSession = (0, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$session$2f$normalize$2d$session$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["normalizeStatelessSession"])(originalSession);
        ...
        for (const cookie of connectionTokenSetsCookies){
            const decryptedCookie = await __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$cookies$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__$3c$locals$3e$__["decrypt"](cookie.value, this.secret);
            if (decryptedCookie) {
     ...
     */ async set(reqCookies, resCookies, session) {
        ...
        const now = this.epoch();
        const expiration = now + maxAge;
        const jwe = await __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$cookies$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__$3c$locals$3e$__["encrypt"](originalSession, this.secret, expiration);
        const cookieValue = jwe.toString();
        const options = {
            ...this.cookieConfig,
            maxAge
        };
        __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$cookies$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__$3c$locals$3e$__["setChunkedCookie"](this.sessionCookieName, cookieValue, options, reqCookies, resCookies);
        ...
        if (__TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$cookies$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getChunkedCookie"](__TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$session$2f$normalize$2d$session$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["LEGACY_COOKIE_NAME"], reqCookies, true)) {
            __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$cookies$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__$3c$locals$3e$__["deleteChunkedCookie"](__TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$session$2f$normalize$2d$session$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["LEGACY_COOKIE_NAME"], reqCookies, resCookies, true, {
                domain: this.cookieConfig.domain,
                path: this.cookieConfig.path
            });
        }
    ...
    async delete(reqCookies, resCookies) {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$cookies$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__$3c$locals$3e$__["deleteChunkedCookie"](this.sessionCookieName, reqCookies, resCookies, false, deleteOptions);
        this.getConnectionTokenSetsCookies(reqCookies).forEach((cookie)=>__TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$cookies$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__$3c$locals$3e$__["deleteCookie"](resCookies, cookie.name, deleteOptions));
    }
    async storeInCookie(reqCookies, resCookies, session, cookieName, maxAge) {
        const expiration = Math.floor(Date.now() / 1000 + maxAge);
        const jwe = await __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$cookies$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__$3c$locals$3e$__["encrypt"](session, this.secret, expiration);
        const cookieValue = jwe.toString();
        ...
        const cookieJarSizeTest = new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$edge$2d$runtime$2f$cookies$2f$dist$2f$index$2e$mjs__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["ResponseCookies"](new Headers());
...
"[project]/docgen/ui/node_modules/@auth0/nextjs-auth0/dist/server/transaction-store.js [middleware-edge] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class TransactionStore {
     ...
     */ async save(resCookies, transactionState, reqCookies) {
        ...
        const jwe = await __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$cookies$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__$3c$locals$3e$__["encrypt"](transactionState, this.secret, expiration);
    ...
    async get(reqCookies, state) {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$cookies$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__$3c$locals$3e$__["decrypt"](cookieValue, this.secret);
    }
    async delete(resCookies, state) {
        __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$cookies$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__$3c$locals$3e$__["deleteCookie"](resCookies, this.getTransactionCookieName(state), {
     ...
     */ async deleteAll(reqCookies, resCookies) {
        ...
        reqCookies.getAll().forEach((cookie)=>{
            if (cookie.name.startsWith(txnPrefix)) {
                __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$cookies$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__$3c$locals$3e$__["deleteCookie"](resCookies, cookie.name, deleteOptions);
            }
        });
    }
}
}),
"[project]/docgen/ui/node_modules/@auth0/nextjs-auth0/dist/server/client.js [middleware-edge] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$next$2f$headers$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/docgen/ui/node_modules/next/headers.js [middleware-edge] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/docgen/ui/node_modules/next/server.js [middleware-edge] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$errors$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/docgen/ui/node_modules/@auth0/nextjs-auth0/dist/errors/index.js [middleware-edge] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$utils$2f$constants$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/docgen/ui/node_modules/@auth0/nextjs-auth0/dist/utils/constants.js [middleware-edge] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$utils$2f$dpopUtils$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/docgen/ui/node_modules/@auth0/nextjs-auth0/dist/utils/dpopUtils.js [middleware-edge] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$utils$2f$request$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/docgen/ui/node_modules/@auth0/nextjs-auth0/dist/utils/request.js [middleware-edge] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$utils$2f$session$2d$changes$2d$helpers$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/docgen/ui/node_modules/@auth0/nextjs-auth0/dist/utils/session-changes-helpers.js [middleware-edge] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$auth$2d$client$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/docgen/ui/node_modules/@auth0/nextjs-auth0/dist/server/auth-client.js [middleware-edge] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$cookies$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/docgen/ui/node_modules/@auth0/nextjs-auth0/dist/server/cookies.js [middleware-edge] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$edge$2d$runtime$2f$cookies$2f$dist$2f$index$2e$mjs__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/docgen/ui/node_modules/@edge-runtime/cookies/dist/index.mjs [middleware-edge] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$helpers$2f$with$2d$api$2d$auth$2d$required$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/docgen/ui/node_modules/@auth0/nextjs-auth0/dist/server/helpers/with-api-auth-required.js [middleware-edge] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$helpers$2f$with$2d$page$2d$auth$2d$required$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/docgen/ui/node_modules/@auth0/nextjs-auth0/dist/server/helpers/with-page-auth-required.js [middleware-edge] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$next$2d$compat$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/docgen/ui/node_modules/@auth0/nextjs-auth0/dist/server/next-compat.js [middleware-edge] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$session$2f$stateful$2d$session$2d$store$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/docgen/ui/node_modules/@auth0/nextjs-auth0/dist/server/session/stateful-session-store.js [middleware-edge] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$session$2f$stateless$2d$session$2d$store$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/docgen/ui/node_modules/@auth0/nextjs-auth0/dist/server/session/stateless-session-store.js [middleware-edge] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$transaction$2d$store$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/docgen/ui/node_modules/@auth0/nextjs-auth0/dist/server/transaction-store.js [middleware-edge] (ecmascript)");
...
class Auth0Client {
    constructor(options = {}){
        ...
        const { dpopKeyPair: resolvedDpopKeyPair, dpopOptions: resolvedDpopOptions } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$utils$2f$dpopUtils$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["validateDpopConfiguration"])(options);
        ...
        this.transactionStore = new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$transaction$2d$store$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["TransactionStore"]({
            secret,
            cookieOptions: transactionCookieOptions,
            enableParallelTransactions: options.enableParallelTransactions ?? true
        });
        this.sessionStore = options.sessionStore ? new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$session$2f$stateful$2d$session$2d$store$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["StatefulSessionStore"]({
            ...options.session,
            secret,
            store: options.sessionStore,
            cookieOptions: sessionCookieOptions
        }) : new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$session$2f$stateless$2d$session$2d$store$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["StatelessSessionStore"]({
            ...options.session,
            secret,
            cookieOptions: sessionCookieOptions
        });
        this.authClient = new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$auth$2d$client$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["AuthClient"]({
     ...
     */ middleware(req) {
        return this.authClient.handler.bind(this.authClient)((0, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$next$2d$compat$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["toNextRequest"])(req));
    }
    /**
     ...
     */ async getSession(req) {
        if (req) {
            ...
            if (req instanceof Request) {
                const nextReq = (0, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$next$2d$compat$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["toNextRequest"])(req);
        ...
        return this.sessionStore.get(await (0, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$next$2f$headers$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["cookies"])());
    }
    /**
     ...
     */ async executeGetAccessToken(req, res, options) {
        ...
        if (!session) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$errors$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["AccessTokenError"](__TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$errors$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["AccessTokenErrorCode"].MISSING_SESSION, "The user does not have an active session.");
        }
        ...
        // update the session with the new token set, if necessary
        const sessionChanges = (0, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$utils$2f$session$2d$changes$2d$helpers$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["getSessionChangesAfterGetAccessToken"])(session, tokenSet, {
            scope: __classPrivateFieldGet(this, _Auth0Client_options, "f").authorizationParameters?.scope ?? __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$utils$2f$constants$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["DEFAULT_SCOPES"],
     ...
     */ async updateSession(reqOrSession, res, sessionData) {
        ...
        if (reqOrSession instanceof Request && !(reqOrSession instanceof __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextRequest"])) {
            reqOrSession = (0, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$next$2d$compat$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["toNextRequest"])(reqOrSession);
        }
        // Normalize plain Response (Next 16 Node runtime) to NextResponse
        if (res && res instanceof Response && !(res instanceof __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"])) {
            res = (0, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$next$2d$compat$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["toNextResponse"])(res);
        }
        if (!res) {
            ...
            await this.sessionStore.set(await (0, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$next$2f$headers$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["cookies"])(), await (0, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$next$2f$headers$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["cookies"])(), {
                ...updatedSession,
                internal: {
            ...
            if (req instanceof __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextRequest"] && res instanceof __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"]) {
                // middleware usage
                ...
                const resCookies = new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$edge$2d$runtime$2f$cookies$2f$dist$2f$index$2e$mjs__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["ResponseCookies"](resHeaders);
    ...
    createRequestCookies(req) {
        ...
        return new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$edge$2d$runtime$2f$cookies$2f$dist$2f$index$2e$mjs__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["RequestCookies"](headers);
    }
    async startInteractiveLogin(options = {}) {
     ...
     */ async connectAccount(options) {
        ...
        if (!session) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$errors$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["ConnectAccountError"]({
                code: __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$errors$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["ConnectAccountErrorCodes"].MISSING_SESSION,
                message: "The user does not have an active session."
            });
        }
    ...
    withPageAuthRequired(fnOrOpts, opts) {
        ...
        const appRouteHandler = (0, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$helpers$2f$with$2d$page$2d$auth$2d$required$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["appRouteHandlerFactory"])(this, config);
        const pageRouteHandler = (0, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$helpers$2f$with$2d$page$2d$auth$2d$required$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["pageRouteHandlerFactory"])(this, config);
    ...
    withApiAuthRequired(apiRoute) {
        const pageRouteHandler = __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$helpers$2f$with$2d$api$2d$auth$2d$required$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["pageRouteHandlerFactory"](this);
        const appRouteHandler = __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$server$2f$helpers$2f$with$2d$api$2d$auth$2d$required$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["appRouteHandlerFactory"](this);
        return (req, resOrParams)=>{
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f40$auth0$2f$nextjs$2d$auth0$2f$dist$2f$utils$2f$request$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["isRequest"])(req)) {
    ...
    async saveToSession(data, req, res) {
        if (req && res) {
            ...
            // app router usage: Server Components, Server Actions, Route Handlers
            try {
                await this.sessionStore.set(await (0, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$next$2f$headers$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["cookies"])(), await (0, __TURBOPACK__imported__module__$5b$project$5d2f$docgen$2f$ui$2f$node_modules$2f$next$2f$headers$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["cookies"])(), data);
            } catch (e) {
...
"[project]/docgen/ui/node_modules/@auth0/nextjs-auth0/dist/server/index.js [middleware-edge] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=70d1f_%40auth0_nextjs-auth0_ab31d033._.js.map